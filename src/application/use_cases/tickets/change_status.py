...
class ChangeStatusUseCase:
    ...
    def execute(self, dto: AlterarStatusDTO, usuario: Usuario) -> ChamadoResponseDTO:
        """
        ...
        with self.unit_of_work:
            ...
            chamado.alterar_status(
                novo_status=dto.novo_status, perfil_usuario=usuario.perfil, usuario_id=usuario.id
            )
