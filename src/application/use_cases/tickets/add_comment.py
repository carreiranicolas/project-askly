...
from src.domain.entities import Comentario, Usuario
...
class AddCommentUseCase:
    ...
    def execute(self, dto: ComentarioCreateDTO, usuario: Usuario) -> ComentarioResponseDTO:
        """
        ...
        if not dto.conteudo or not dto.conteudo.strip():
            raise ValidationException("O comentário não pode estar vazio", field="conteudo")
        ...
        return ComentarioResponseDTO.from_entity(comentario, autor_nome=usuario.nome)
