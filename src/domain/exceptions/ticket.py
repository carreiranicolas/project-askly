...
class InvalidStatusTransitionException(TicketException):
    ...
    def __init__(self, status_atual: str, status_destino: str, motivo: str | None = None):
...
class TicketClosedException(TicketException):
    ...
    def __init__(self, ticket_id: str | None = None):
        ...
        super().__init__(message=msg, code="TICKET_CLOSED", details={"ticket_id": ticket_id})
...
class ReopenDeadlineExpiredException(TicketException):
    ...
    def __init__(self, dias_limite: int = 3):
        ...
        super().__init__(
            message=msg, code="REOPEN_DEADLINE_EXPIRED", details={"dias_limite": dias_limite}
        )
