...
from src.application.use_cases import ChangeProfileUseCase, ListUsersUseCase
...
change_profile_model = users_ns.model(
    "ChangeProfile",
    {
        "perfil": fields.String(
            required=True, description="Novo perfil", enum=["solicitante", "atendente", "admin"]
        ),
    },
)
