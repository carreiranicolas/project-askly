...
login_model = auth_ns.model(
    ...
    {
        "email": fields.String(
            required=True, description="Email do usuário", example="usuario@empresa.com"
        ),
...
register_model = auth_ns.model(
    "Register",
    {
        ...
        "senha": fields.String(
            required=True, description="Senha (mín. 6 caracteres)", example="minhasenha123"
        ),
        "confirmar_senha": fields.String(
            required=True, description="Confirmação da senha", example="minhasenha123"
        ),
    },
)
