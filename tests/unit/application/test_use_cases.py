...
from src.application.dtos import LoginDTO, ChamadoCreateDTO, AlterarStatusDTO
from src.application.use_cases import LoginUseCase, CreateTicketUseCase, ChangeStatusUseCase
from src.domain.entities import Usuario, Chamado, HistoricoStatus
from src.domain.enums import PerfilUsuario, StatusChamado, Prioridade
from src.domain.exceptions import InvalidCredentialsException, UserInactiveException
from tests.fixtures.factories import UsuarioFactory, ChamadoFactory, CategoriaFactory
